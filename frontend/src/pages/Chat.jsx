...
export default function Chat() {
  ...
  const typeMessage = async (text) => {
    ...
    try {
      ...
      messageToType = jsonData.raw_data?.text || jsonData.text || JSON.stringify(jsonData);
    } catch (e) {
      messageToType = text;
    }
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // The server returns e.g. { text: "...", raw_data: {...}, error?: ... }
      const { data } = response;
      ...
      if (error) {
        ...
        const formattedText = formatResponse(text, trimmed);
